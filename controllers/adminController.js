        ...
        if (student) {
            ...
            if (req.body.status === 'Approved' && oldStatus !== 'Approved') {
                ...
                const message = `
                    ...
                    <p>Please login at the <a href="${process.env.PORTAL_URL || process.env.FRONTEND_URL || 'https://medicalcareer.netlify.app'}/student-login.html">Student Portal</a> and change your password immediately.</p>
                `;
